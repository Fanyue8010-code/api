    ...
    public class Refund
    {
        public class ApplyAmount
        {
          ...
          //  public string notify_url { set; get; }
            ...
            /// 退款金额实体
            /// </summary>
            public RefundsAmountModel amount { set; get; } = new RefundsAmountModel();

            public List<RefundsDetailModel> goods_detail { get; set; } = new List<RefundsDetailModel>(); // 新增属性

            public string reason { set; get; }
        }

        public class RefundsDetailModel
        {
            
            public string merchant_goods_id { set; get; }
            public string goods_name { set; get; }
            public int unit_price { set; get; }
            public int refund_amount { set; get; }
            public int refund_quantity { set; get; }
        }
